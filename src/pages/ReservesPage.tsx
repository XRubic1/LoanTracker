              ...
              list.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-1.5 pr-2 border-b border-divider align-middle font-mono">
                    ...
                    <td className="py-1.5 pr-2 border-b border-divider align-middle font-mono text-[11px] text-muted2">
                      {lastDeducted}
                    </td>
